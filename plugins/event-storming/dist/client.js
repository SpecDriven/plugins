...
__iconData2.node;
var SquareDashed = createLucideIcon(__iconData2);
...
__iconData3.node;
var Trash = createLucideIcon(__iconData3);
...
__iconData5.node;
var ClipboardCopy = createLucideIcon(__iconData5);
...
__iconData6.node;
var Copy = createLucideIcon(__iconData6);
...
__iconData7.node;
var Download = createLucideIcon(__iconData7);
...
__iconData8.node;
var EyeOff = createLucideIcon(__iconData8);
...
__iconData9.node;
var Eye = createLucideIcon(__iconData9);
...
__iconData10.node;
var Flag = createLucideIcon(__iconData10);
...
__iconData11.node;
var Link = createLucideIcon(__iconData11);
...
__iconData12.node;
var Maximize = createLucideIcon(__iconData12);
...
__iconData13.node;
var PanelRightClose = createLucideIcon(__iconData13);
...
__iconData14.node;
var PanelRightOpen = createLucideIcon(__iconData14);
...
__iconData15.node;
var Pencil = createLucideIcon(__iconData15);
...
__iconData16.node;
var Play = createLucideIcon(__iconData16);
...
__iconData17.node;
var Plus = createLucideIcon(__iconData17);
...
__iconData18.node;
var Redo2 = createLucideIcon(__iconData18);
...
__iconData19.node;
var StickyNote = createLucideIcon(__iconData19);
...
__iconData21.node;
var Upload = createLucideIcon(__iconData21);
...
// src/ui/storm.css
var storm_default = `/* ---- Event Storming ----
   The wall: sticky notes in the classic legend's colours on the app's own
   surface, which follows the theme while the paper does not — a sticky is
   the same orange in a dark room. Areas are dashed frames beneath them. */
...
.storm-wall:focus-visible {
  box-shadow: 0 0 0 2px var(--ring);
}

.storm-wall .react-flow {
  background: var(--surface-0);
  --xy-background-pattern-dots-color-default: var(--border-strong);
  --xy-edge-stroke-default: var(--text-2);
  --xy-edge-stroke-selected-default: var(--accent);
  --xy-edge-stroke-width-default: 1.75;
  ...
  --xy-selection-background-color-default: light-dark(rgba(94, 106, 210, 0.08), rgba(110, 121, 230, 0.12));
  --xy-selection-border-default: 1px dashed var(--accent);
}

.storm-wall .react-flow__edge-path {
  stroke-linecap: round;
}

.storm-wall .react-flow__edge.selected .react-flow__edge-path,
.storm-wall .react-flow__edge:focus .react-flow__edge-path {
  stroke: var(--accent);
  stroke-width: 2.5;
}

.storm-wall .react-flow__arrowhead polyline {
  fill: var(--text-2);
  stroke: var(--text-2);
}

/* The nodes draw their own selection. */
.storm-wall .react-flow__node.selected,
.storm-wall .react-flow__node:focus,
.storm-wall .react-flow__node:focus-visible {
  box-shadow: none;
  outline: none;
}
...
.react-flow__node.dragging .storm-sticky {
  cursor: grabbing;
  box-shadow:
...
.storm-writer::placeholder {
  color: inherit;
  opacity: 0.45;
}

/* An actor is the small yellow one, a head and shoulders beside its name. */
.storm-actor {
  padding: 0.3rem 0.45rem 0.35rem;
}

.storm-actor .storm-kind::before {
  content: "☺ ";
}

/* An aggregate is the big yellow one; its name sits at the top, where the
   workshop writes it before the rules underneath. */
.storm-aggregate .storm-text {
  align-items: flex-start;
  padding-top: 0.4rem;
  font-weight: 700;
}

/* A hotspot is stuck on its corner. The diamond is drawn behind the text
   so the text stays level. */
.storm-hotspot {
...
.storm-hotspot .storm-kind,
.storm-hotspot .storm-text,
.storm-hotspot .storm-writer {
  position: relative;
}
...
.storm-hotspot.selected {
  outline: none;
}

.storm-hotspot.selected .storm-diamond {
  outline: 2.5px solid var(--accent);
  outline-offset: 2px;
}
...
/* An external system is the wide pink one. */
.storm-external .storm-kind::before {
  content: "⧉ ";
}

/* A note is plain paper, with a border so it reads on a light wall. */
.storm-note {
  border: 1px solid rgba(0, 0, 0, 0.12);
}

/* A pivotal event: the boundary line taped through it, top to bottom of
   the wall, behind every other sticky (flow.ts puts it a layer lower). */
.storm-sticky.pivotal {
  box-shadow:
    0 0 0 3px var(--ink),
    0 6px 12px -6px rgba(0, 0, 0, 0.35);
}

.storm-sticky.pivotal::before {
  content: "";
  position: absolute;
  left: calc(50% - 2px);
  top: -2400px;
  bottom: -2400px;
  z-index: -1;
  border-left: 4px dashed light-dark(rgba(214, 107, 0, 0.45), rgba(255, 169, 77, 0.45));
  pointer-events: none;
}

/* Arrows are drawn from a sticky's right edge to another's left. */
.storm-handle.react-flow__handle {
  width: 10px;
  height: 10px;
  opacity: 0;
...
.storm-sticky:hover .storm-handle,
.react-flow.connecting .storm-handle,
.react-flow__node.selected .storm-handle {
  opacity: 1;
}

.storm-hotspot .storm-handle.react-flow__handle-left {
  left: 14%;
}

.storm-hotspot .storm-handle.react-flow__handle-right {
  right: 14%;
}

/* ---- An area ---- */

/* The frame lets the pointer through to the wall — only its label and its
   resize handles take it — so a selection box or a pan can start inside. */
.storm-wall .react-flow__node.storm-area-node {
  pointer-events: none;
}
...
.storm-area {
  ...
  height: 100%;
  box-sizing: border-box;
  border: 2px dashed light-dark(rgba(60, 70, 90, 0.35), rgba(200, 210, 230, 0.3));
  border-radius: var(--radius-lg);
  background: light-dark(rgba(60, 70, 90, 0.035), rgba(200, 210, 230, 0.04));
}
...
.storm-area-label.blank {
  color: var(--text-3);
  font-style: italic;
  font-weight: 500;
}

.storm-area-label.editing {
  padding: 0;
  cursor: auto;
}

.storm-area-label .storm-writer {
  min-width: 14rem;
  margin: 0;
  border: none;
  background: var(--surface-0);
...
.storm-wall .storm-resize-handle,
.storm-wall .storm-resize-line {
  pointer-events: all;
}

.storm-wall .storm-resize-handle.react-flow__resize-control.handle {
  width: 9px;
  height: 9px;
  border-radius: 2px;
  background: var(--surface-0);
...
.storm-wall .storm-resize-line.react-flow__resize-control.line {
  border-color: var(--accent);
}

/* ---- The timeline above the stickies ---- */
...
.storm-selection.react-flow__panel {
  display: flex;
  align-items: center;
  gap: 0.25rem;
  padding: 0.3rem;
...
.storm-swatch-aggregate {
  width: 16px;
  height: 16px;
}

.storm-swatch-external {
  width: 18px;
  height: 11px;
}

.storm-swatch-hotspot {
  width: 11px;
  height: 11px;
  margin: 0 1.5px;
  transform: rotate(45deg);
...
.storm-legend-list li {
  display: flex;
  align-items: center;
  gap: 0.25rem;
}

.storm-legend-list li.off .storm-legend-add {
  opacity: 0.45;
}
...
.storm-legend-add:hover {
  background: var(--hover);
}

.storm-legend-add .storm-swatch {
  margin: 0 auto;
}

.storm-legend-add > .storm-swatch,
.storm-legend-add > .storm-area-icon {
  width: 18px;
  flex: none;
}
...
.storm-legend-add > .storm-swatch-aggregate { width: 16px; margin: 0 1px; }
.storm-legend-add > .storm-swatch-external { width: 18px; margin: 0; }
.storm-legend-add > .storm-swatch-hotspot { width: 11px; margin: 0 3.5px; }
...
/* ---- An empty wall, and no board at all ---- */
...
.storm-welcome-legend li {
  display: grid;
  grid-template-columns: 1.4rem 1fr;
  align-items: start;
}

.storm-welcome-legend .storm-swatch {
  margin-top: 0.15rem;
}

.storm-welcome-legend strong {
  color: var(--text-1);
}

.storm-welcome-actions {
  display: flex;
  gap: 0.5rem;
}

.storm-welcome-actions button {
  height: 2rem;
  padding: 0 0.9rem;
...
.storm-welcome-actions button.primary {
  border-color: var(--accent);
  background: var(--accent);
  color: var(--on-accent);
}

.storm-welcome-actions button.primary:hover {
...
function normalizeStormFile(raw, fallbackName = "") {
  const r = record(raw);
  const seen = new Set;
  const unique = (id2, prefix) => {
    let out = typeof id2 === "string" && id2.trim() ? id2.trim() : newId2(prefix);
    while (seen.has(out))
      out = newId2(prefix);
    seen.add(out);
    return out;
...
function parseStormsRoute(pathname) {
  const segs = pathname.split("/").filter(Boolean).map(decode);
  if (segs[0] !== STORMS_FOLDER)
    return null;
  if (!segs[1])
...
function toFlow(file, hidden) {
  ...
  const stickies = file.stickies.map((sticky) => ({
    id: sticky.id,
    type: "sticky",
  ...
  const edges = file.arrows.map((arrow) => ({
    id: arrow.id,
    source: arrow.from,
    target: arrow.to,
    zIndex: 3,
...
function stickyBounds(file) {
  if (file.stickies.length === 0)
    return null;
  let x = Infinity;
  let y = Infinity;
  let right = -Infinity;
...
// src/ui/mutations.ts
var GRID = 16;
var snap = (n) => Math.round(n / GRID) * GRID;
function addSticky(file, kind, at, text = "") {
  const { width, height } = STICKY[kind];
  const id2 = newId2("s");
  const sticky = { id: id2, kind, text, x: snap(at.x - width / 2), y: snap(at.y - height / 2) };
  return { file: { ...file, stickies: [...file.stickies, sticky] }, id: id2 };
}
function addArea(file, at, label = "") {
  const width = MIN_AREA.width * 3;
  const height = MIN_AREA.height * 3;
  const id2 = newId2("a");
  const area = { id: id2, label, x: snap(at.x - width / 2), y: snap(at.y - height / 2), width, height };
  return { file: { ...file, areas: [...file.areas, area] }, id: id2 };
}
function updateSticky(file, id2, patch) {
  return {
    ...file,
    stickies: file.stickies.map((s) => {
      if (s.id !== id2)
        return s;
      const next = { ...s, ...patch };
      if (next.kind !== "event" || !next.pivotal)
        delete next.pivotal;
      return next;
    })
  };
}
function updateArea(file, id2, patch) {
  return {
    ...file,
    areas: file.areas.map((a) => a.id === id2 ? {
      ...a,
      ...patch,
...
function moveTo(file, positions) {
  const moved = (item) => {
...
function connect(file, from, to) {
  if (from === to || file.arrows.some((a) => a.from === from && a.to === to))
    return null;
  const ids = new Set(file.stickies.map((s) => s.id));
  if (!ids.has(from) || !ids.has(to))
    return null;
  return { ...file, arrows: [...file.arrows, { id: newId2("r"), from, to }] };
}
function duplicate(file, ids) {
  const wanted = new Set(ids);
  const renamed = new Map;
  const offset = GRID * 2;
  const stickies = file.stickies.filter((s) => wanted.has(s.id)).map((s) => {
    const id2 = newId2("s");
    renamed.set(s.id, id2);
    return { ...s, id: id2, x: s.x + offset, y: s.y + offset };
  });
  const areas = file.areas.filter((a) => wanted.has(a.id)).map((a) => {
    const id2 = newId2("a");
    renamed.set(a.id, id2);
    return { ...a, id: id2, x: a.x + offset, y: a.y + offset };
  });
  const arrows = file.arrows.filter((a) => renamed.has(a.from) && renamed.has(a.to)).map((a) => ({ id: newId2("r"), from: renamed.get(a.from), to: renamed.get(a.to) }));
  return {
    file: {
      ...file,
...
// src/ui/nodes.tsx
init_react();
var WallActionsContext = createContext({
  editing: null,
  startEdit: () => {},
  commitText: () => {},
  cancelEdit: () => {},
...
function StickyView({ data, selected: selected2 }) {
  const { sticky } = data;
  const info = STICKY[sticky.kind];
  const actions = useContext(WallActionsContext);
  const editing = actions.editing === sticky.id;
  return /* @__PURE__ */ jsxs("div", {
    className: `storm-sticky storm-${sticky.kind}${sticky.pivotal ? " pivotal" : ""}${selected2 ? " selected" : ""}`,
    style: { ["--paper"]: info.color, ["--ink"]: info.ink },
    ...
    children: [
      /* @__PURE__ */ jsx(Handle, {
        ...
        className: "storm-handle"
      }),
      sticky.kind === "hotspot" && /* @__PURE__ */ jsx("span", {
        className: "storm-diamond",
        "aria-hidden": "true"
      }),
      /* @__PURE__ */ jsx("span", {
        className: "storm-kind",
        "aria-hidden": "true",
        children: sticky.pivotal ? "Pivotal event" : info.label
      }),
      editing ? /* @__PURE__ */ jsx(Writer, {
        initial: sticky.text,
        ...
        className: `storm-text${sticky.text ? "" : " blank"}`,
        style: { fontSize: fontSize(sticky.text, sticky.kind) },
        children: sticky.text || info.example
      }),
      /* @__PURE__ */ jsx(Handle, {
        type: "source",
...
function AreaView({ id: id2, data, selected: selected2 }) {
  const { area } = data;
  const actions = useContext(WallActionsContext);
  const editing = actions.editing === area.id;
  return /* @__PURE__ */ jsxs("div", {
    className: `storm-area${selected2 ? " selected" : ""}`,
    children: [
      /* @__PURE__ */ jsx(NodeResizer, {
        ...
        onResizeEnd: (_e, box) => actions.resizeArea(id2, box)
      }),
      editing ? /* @__PURE__ */ jsx("div", {
        className: "storm-area-label editing",
        children: /* @__PURE__ */ jsx(Writer, {
          initial: area.label,
        ...
        children: area.label || "Unnamed area"
      })
    ]
  });
}
var nodeTypes = { sticky: StickyView, area: AreaView };

// src/ui/store.ts
init_react();
var EMPTY_STORMS = { storms: [], loaded: false, error: null };
var state = EMPTY_STORMS;
...
var storms = {
  ...
  async load() {
    try {
      const data = await call("/api/storms");
      set3({ storms: data.storms, loaded: true, error: null });
    } catch (e) {
  ...
  async remove(fileName) {
    try {
      const data = await call(`/api/storms/${encodeURIComponent(fileName)}`, {
        method: "DELETE"
      });
      await storms.load();
      return data.message;
...
function Swatch({ kind }) {
  return /* @__PURE__ */ jsx("span", {
    ...
    style: { ["--paper"]: STICKY[kind].color },
    "aria-hidden": "true"
  });
}
function StormPane(props) {
  return /* @__PURE__ */ jsx(ReactFlowProvider, {
    children: /* @__PURE__ */ jsx(Wall, {
      ...props
    })
  });
}
function Wall({
  ...
  const derive = useCallback((next, hiddenKinds) => {
    ...
    setEdges((prev) => {
      const keep = wanted ? new Set : new Set(prev.filter((e) => e.selected).map((e) => e.id));
  ...
  const load = useCallback(async () => {
    ...
    if (current && savedRef.current && current !== savedRef.current)
      return;
    if (current && serializeStormFile(current) === serializeStormFile(data.file))
      return;
    if (current) {
      past.current = [];
      future.current = [];
  ...
  const dropFresh = (id2) => {
    ...
    fresh.current = null;
    if (!f || f.id !== id2 || past.current.at(-1) !== f.before)
      return false;
    past.current = past.current.slice(0, -1);
    restore(f.before);
    return true;
  ...
  const actions = useMemo(() => ({
    editing,
    startEdit: (id2) => setEditing(id2),
    commitText: (id2, text) => {
      setEditing(null);
      const current = fileRef.current;
      if (!current)
        return;
      const sticky = current.stickies.find((s) => s.id === id2);
      if (sticky) {
        if (!text && dropFresh(id2))
          return;
        fresh.current = null;
        if (sticky.text !== text)
          apply(updateSticky(current, id2, { text }));
        return;
      }
      const area = current.areas.find((a) => a.id === id2);
      if (area && area.label !== text)
        apply(updateArea(current, id2, { label: text }));
    },
    cancelEdit: () => {
      const id2 = editing;
      setEditing(null);
    ...
    resizeArea: (id2, box) => {
      if (fileRef.current)
        apply(updateArea(fileRef.current, id2, box));
    }
  }), [editing, apply]);
  const onSelectionChange = useCallback(({ nodes: picked, edges: arrows }) => {
  ...
  const onConnect = useCallback((c) => {
    const current = fileRef.current;
    if (current)
      apply(connect(current, c.source, c.target), "Those two are joined already.");
  }, [apply]);
  const onDelete = useCallback(({ nodes: gone, edges: cut }) => {
    const current = fileRef.current;
    if (!current || gone.length === 0 && cut.length === 0)
      return;
    apply(removeIds(current, [...gone.map((n) => n.id), ...cut.map((e) => e.id)]));
    setSelected([]);
  }, [apply]);
  const selectedStickies = useMemo(() => file ? file.stickies.filter((s) => selected2.includes(s.id)) : [], [file, selected2]);
  const selectedAreas = useMemo(() => file ? file.areas.filter((a) => selected2.includes(a.id)) : [], [file, selected2]);
  const recolour = (kind) => {
    let current = fileRef.current;
    if (!current)
      return;
    for (const s of selectedStickies)
      current = updateSticky(current, s.id, { kind });
    apply(current);
  };
  const togglePivotal = () => {
    let current = fileRef.current;
    ...
    for (const s of selectedStickies)
      current = updateSticky(current, s.id, { pivotal: on });
    apply(current);
  };
  const duplicateSelection = () => {
    const current = fileRef.current;
    const ids = selected2.filter((id2) => current?.stickies.some((s) => s.id === id2) || current?.areas.some((a) => a.id === id2));
  ...
  const deleteSelection = () => {
    const current = fileRef.current;
    if (!current || selected2.length === 0)
      return;
    apply(removeIds(current, selected2));
    setSelected([]);
  };
  const onKeyDown = (e) => {
    if (editing || typingInField(e.target))
      return;
    ...
    } else if (e.key === "Enter" && selected2.length === 1) {
      const id2 = selected2[0];
      if (file?.stickies.some((s) => s.id === id2) || file?.areas.some((a) => a.id === id2)) {
        e.preventDefault();
        setEditing(id2);
      }
    }
  ...
  const copyOutline = () => {
    if (!fileRef.current)
      return;
    navigator.clipboard.writeText(stormOutline(fileRef.current)).then(() => toast.success("Copied the board's timeline as Markdown.")).catch(() => toast.error("Could not copy to the clipboard."));
  };
  const remove2 = async () => {
    if (!fileRef.current)
      return;
  ...
  const link2 = stormLink(fileName);
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
        ...
        children: [
          /* @__PURE__ */ jsx(Breadcrumbs, {
            ...
            tail: /* @__PURE__ */ jsx("span", {
              ...
              children: file.name || stormStem(fileName)
            })
          }),
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(Tooltip, {
                label: "Download the board as JSON",
                children: /* @__PURE__ */ jsx("a", {
                  className: "ibtn",
                  href: stormExportUrl(fileName),
                  download: true,
                  "aria-label": "Download",
              ...
              /* @__PURE__ */ jsxs("span", {
                className: "chip-anchor storm-menu-anchor",
                children: [
                  /* @__PURE__ */ jsx("button", {
                    type: "button",
                    className: "ibtn",
                  ...
                  /* @__PURE__ */ jsx(Menu, {
                    ...
                    items: [
                      { id: "rename", label: "Rename", icon: /* @__PURE__ */ jsx(Pencil, {
                        size: 13
                      }), onSelect: () => void rename() },
                      {
                        id: "outline",
                        label: "Copy timeline as Markdown",
                        icon: /* @__PURE__ */ jsx(ClipboardCopy, {
                          size: 13
                        }),
                      ...
                      { id: "delete", label: "Delete board", icon: /* @__PURE__ */ jsx(Trash, {
                        size: 13
              ...
              /* @__PURE__ */ jsx(Tooltip, {
                ...
                children: /* @__PURE__ */ jsx("button", {
                  ...
                  children: legendOpen ? /* @__PURE__ */ jsx(PanelRightClose, {
                    size: 15,
                    "aria-hidden": "true"
      ...
      /* @__PURE__ */ jsxs("div", {
        className: `storm-body${legendOpen ? "" : " no-legend"}`,
        children: [
          /* @__PURE__ */ jsxs("div", {
            ref: wallRef,
            ...
            onDoubleClick,
            children: [
              /* @__PURE__ */ jsx(WallActionsContext.Provider, {
                value: actions,
                children: /* @__PURE__ */ jsxs(index2, {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx(MiniMap, {
                      pannable: true,
                      zoomable: true,
                      nodeColor: (n) => n.type === "sticky" ? STICKY[n.data.sticky.kind].color : "transparent",
                      nodeStrokeWidth: 2
                    }),
                    bounds && /* @__PURE__ */ jsx(ViewportPortal, {
                    ...
                    (selectedStickies.length > 0 || selectedAreas.length > 0) && !editing && /* @__PURE__ */ jsxs(Panel, {
                      position: "top-center",
                      className: "storm-selection",
                      "aria-label": "Selection",
                      children: [
                        selectedStickies.length > 0 && /* @__PURE__ */ jsxs(Fragment2, {
                          children: [
                            /* @__PURE__ */ jsx("span", {
                              className: "storm-selection-swatches",
                              role: "group",
                              "aria-label": "Kind",
                              children: STICKY_KINDS.map((kind) => /* @__PURE__ */ jsx(Tooltip, {
                                label: `Make ${selectedStickies.length === 1 ? "it" : "them"} ${STICKY[kind].label.toLowerCase()}`,
                                children: /* @__PURE__ */ jsx("button", {
                                  type: "button",
                            ...
                            allEvents && /* @__PURE__ */ jsx(Tooltip, {
                              label: "A pivotal event: the story changes phase after it",
                        ...
                        selected2.length === 1 && /* @__PURE__ */ jsx(Tooltip, {
                          label: "Write on it (Enter)",
                          children: /* @__PURE__ */ jsx("button", {
                            type: "button",
                            className: "storm-bar-btn",
                            "aria-label": "Edit",
                            onClick: () => setEditing(selected2[0]),
                        ...
                        /* @__PURE__ */ jsx(Tooltip, {
                          ...
                          children: /* @__PURE__ */ jsx("button", {
                            type: "button",
                            className: "storm-bar-btn danger",
                            "aria-label": "Delete",
              ...
              file.stickies.length === 0 && file.areas.length === 0 && /* @__PURE__ */ jsxs("div", {
                className: "storm-empty",
                children: [
                  /* @__PURE__ */ jsx(StickyNote, {
                    size: 28,
                    "aria-hidden": "true"
                  }),
                  /* @__PURE__ */ jsx("p", {
                    children: "An empty wall. Start as the workshop does: double-click anywhere to stick a domain event, one thing that happened per sticky, in the past tense."
                  })
                ]
              })
            ]
          }),
          legendOpen && /* @__PURE__ */ jsx(Legend, {
            counts,
            hidden,
            onAdd: (kind) => add(kind, centre()),
            onAddArea: newArea,
            onToggle: (kind) => setHidden((h) => {
              const next = new Set(h);
              if (next.has(kind))
                next.delete(kind);
              else
...
function Legend({
  ...
  return /* @__PURE__ */ jsxs("aside", {
    className: "storm-legend",
    "aria-label": "Legend",
    children: [
      /* @__PURE__ */ jsxs("div", {
        className: "storm-legend-head",
        children: [
          /* @__PURE__ */ jsx("span", {
            className: "storm-legend-title",
            children: "Legend"
          }),
          /* @__PURE__ */ jsx(Tooltip, {
            label: "Fit the board in view",
            children: /* @__PURE__ */ jsx("button", {
              type: "button",
              className: "ibtn",
              "aria-label": "Fit the board in view",
              onClick: onFit,
      ...
      /* @__PURE__ */ jsxs("ul", {
        className: "storm-legend-list",
        children: [
          STICKY_KINDS.map((kind, i) => /* @__PURE__ */ jsxs("li", {
            className: hidden.has(kind) ? "off" : undefined,
            children: [
...
Adds one (key ${i + 1}).`,
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", {
                    className: "storm-legend-name",
                    children: STICKY[kind].label
                  }),
                  /* @__PURE__ */ jsx("kbd", {
                    children: i + 1
                  })
              ...
              /* @__PURE__ */ jsx("span", {
                className: "storm-legend-count",
                children: counts[kind] ?? 0
              }),
              /* @__PURE__ */ jsx(Tooltip, {
                label: hidden.has(kind) ? `Show ${STICKY[kind].plural.toLowerCase()}` : `Hide ${STICKY[kind].plural.toLowerCase()}`,
                children: /* @__PURE__ */ jsx("button", {
                  type: "button",
                  ...
                  children: hidden.has(kind) ? /* @__PURE__ */ jsx(EyeOff, {
                    size: 13,
                    "aria-hidden": "true"
                  }) : /* @__PURE__ */ jsx(Eye, {
                    size: 13,
        ...
        children: [
          /* @__PURE__ */ jsxs("p", {
            children: [
              ...
              " Double-click the wall for an event, or press 1–9 for a sticky at the pointer."
            ]
          }),
          /* @__PURE__ */ jsx("p", {
            children: "Double-click a sticky or Enter to write on it. Drag from its right dot to another to draw an arrow."
          }),
          /* @__PURE__ */ jsxs("p", {
            children: [
              "Shift-drag to select many; ",
              MOD,
              "D duplicates, ",
              MOD,
              "Z undoes."
      ...
      /* @__PURE__ */ jsxs("details", {
        className: "storm-steps",
        children: [
          /* @__PURE__ */ jsx("summary", {
            children: "Running the workshop"
          }),
          /* @__PURE__ */ jsx("ol", {
            children: STEPS.map(([title, body]) => /* @__PURE__ */ jsxs("li", {
              children: [
...
function Welcome({ onCreate, onExample }) {
  return /* @__PURE__ */ jsxs("div", {
    className: "storm-welcome",
    children: [
      /* @__PURE__ */ jsx(StickyNote, {
        size: 32,
        "aria-hidden": "true"
      ...
      /* @__PURE__ */ jsx("p", {
        children: "A wall of sticky notes for exploring a domain together: the things that happen in it as orange domain events on a timeline, then what causes them and who is involved, each in its own colour."
      }),
      /* @__PURE__ */ jsx("ul", {
        className: "storm-welcome-legend",
        children: STICKY_KINDS.map((kind) => /* @__PURE__ */ jsxs("li", {
          children: [
            /* @__PURE__ */ jsx(Swatch, {
              kind
            }),
      ...
      /* @__PURE__ */ jsxs("div", {
        className: "storm-welcome-actions",
        children: [
          /* @__PURE__ */ jsx("button", {
            type: "button",
            className: "primary",
          ...
          /* @__PURE__ */ jsx("button", {
            type: "button",
            onClick: onExample,
            children: "Start from an example"
          })
        ]
      })
    ]
...
function groups(list2) {
  const map = new Map;
  for (const storm of list2) {
    const dir = storm.fileName.split("/").slice(1, -1).join("/");
    const bucket = map.get(dir) ?? [];
    bucket.push(storm);
    map.set(dir, bucket);
  }
  return [...map].sort(([a], [b]) => a === "" ? -1 : b === "" ? 1 : a.localeCompare(b)).map(([dir, list3]) => ({ dir, storms: list3 }));
}
function summary(storm) {
...
async function newBoard(prompt, seed = {}, initial = "") {
  const name = await prompt({
    title: "import" in seed ? "Import board" : "New Event Storming board",
    hint: "import" in seed ? "A board downloaded from here, or a JSON file saved by the Event Storm web app." : "Use folder/name to create inside a subfolder of storms.",
...
function StormsSidebar({ active, prompt, confirm, onNavigate, onCopyLink, onClosed }) {
  ...
  const imported = async (e) => {
    ...
    const guess = (parsed !== null && typeof parsed === "object" && typeof parsed.name === "string" ? parsed.name : "") || picked.name.replace(/(\.storm)?\.json$/i, "");
    const fileName = await newBoard(prompt, { import: parsed }, guess);
    if (fileName)
      onNavigate(fileName, { push: true });
  };
  const remove2 = async (storm) => {
    const ok = await confirm({
      title: "Delete board",
    ...
    if (active === storm.fileName)
      onClosed(storm.fileName);
  };
  const row = (storm, nested) => /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsx(Tooltip, {
            ...
            children: /* @__PURE__ */ jsx("button", {
              ...
              onClick: () => setMenu((m5) => m5 === storm.fileName ? null : storm.fileName),
              children: /* @__PURE__ */ jsx(Ellipsis, {
                size: 14,
                "aria-hidden": "true"
              })
          ...
          /* @__PURE__ */ jsx(Menu, {
            ...
            items: [
              { id: "copy", label: "Copy link", icon: /* @__PURE__ */ jsx(Link, {
                size: 13
              }), onSelect: () => onCopyLink(stormLink(storm.fileName)) },
              {
                id: "export",
                label: "Download JSON",
              ...
              { id: "delete", label: "Delete", icon: /* @__PURE__ */ jsx(Trash, {
                size: 13
              }), danger: true, onSelect: () => void remove2(storm) }
            ]
          })
        ]
      })
    ...
    children: [
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(Tooltip, {
            label: "Import a board from JSON",
            children: /* @__PURE__ */ jsx("button", {
              className: "storm-import",
              "aria-label": "Import",
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          ...
          groups(store.storms).map(({ dir, storms: list2 }) => /* @__PURE__ */ jsxs("div", {
            children: [
              dir && /* @__PURE__ */ jsx("div", {
                className: "page-group",
                children: dir
              }),
              list2.map((storm) => row(storm, dir !== ""))
            ]
          }, dir || ".")),
          store.loaded && store.storms.length === 0 && /* @__PURE__ */ jsx("p", {
            className: "empty",
            children: "No boards yet"
          })
        ]
      })
    ]
...
var first = () => stormsState().storms[0]?.fileName ?? null;
function Pane2({ view, app, navigate }) {
  const key = useReloadKey();
  const store = useStorms();
  const fileName = view.fileName ?? store.storms[0]?.fileName ?? null;
  if (!fileName) {
    if (!store.loaded)
      return /* @__PURE__ */ jsx(PageSkeleton, {
        cards: 1
      });
    const start2 = async (example) => {
      const made = await newBoard(app.prompt, example ? { example: true } : {});
      if (made)
        navigate({ fileName: made }, { push: true });
    };
    return /* @__PURE__ */ jsx(Welcome, {
      onCreate: () => void start2(false),
      onExample: () => void start2(true)
    });
  }
  return /* @__PURE__ */ jsx(StormPane, {
    fileName,
...
var tab = {
  ...
  Sidebar: ({ view, app, navigate }) => /* @__PURE__ */ jsx(StormsSidebar, {
...
function addStyles() {
  ...
  style2.dataset.plugin = "event-storming";
...
//# debugId=8B2B5E2A2D39E79A64756E2164756E21
